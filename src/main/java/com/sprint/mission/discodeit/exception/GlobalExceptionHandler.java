...
public class GlobalExceptionHandler {
    ...
    private HttpStatus getHttpStatus(ErrorCode errorCode) {
        return switch (errorCode) {
            ...
            case INVALID_JWT_TOKEN, INVALID_ACCESS_TOKEN, INVALID_REFRESH_TOKEN, INVALID_JWT_INFORMATION ->
                    HttpStatus.UNAUTHORIZED;
            case USER_NOT_FOUND, READ_STATUS_NOT_FOUND,
                MESSAGE_NOT_FOUND, CHANNEL_NOT_FOUND, BINARY_CONTENT_NOT_FOUND,
                 PROFILE_NOT_FOUND, JWT_INFORMATION_NOT_FOUND -> HttpStatus.NOT_FOUND;
